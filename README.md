...
### Introduction
This repository is a [ALX SWE](https://www.alxafrica.com/) Project. The school project consisted in writing a shell like sh (Bourne Shell) by Stephen Bourne  , in **C**, using a limited number of standard library functions, So Instead we used ower own function that we rewrited over the past three month [Here](https://github.com/SamZec/alx-low_level_programming/)
...
## Authors
* Affum Z K Samuel [SamZec](https://github.com/SamZec)
* Adjie Philip [Zionme](https://github.com/Zionme)
